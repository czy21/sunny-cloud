...
namespace Sunny.Framework.Core.Model
{
    ...
    {
        [Column(name: "id")] public TK Id { get; set; } = default!;
        [Column(name: "create_time")] public DateTime? CreateTime { get; set; }
        [Column(name: "update_time")] public DateTime? UpdateTime { get; set; }
        [Column(name: "create_user")] public TU CreateUser { get; set; } = default!;
        [Column(name: "update_user")] public TU UpdateUser { get; set; } = default!;
